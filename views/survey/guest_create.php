...
<div class="fullpage">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-3 col-md-offset-9 col-xs-6 col-xs-offset-6">
          <a class="btn btn-xl btn-block btn-primary" href="#step-1"><?= Yii::t('app', 'Next') ?></a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="section" data-anchor="step-<?= $current ?>">
    <div class="container panel">
      ...
      <hr>
      <?= $form->field($model, 'token_code', ['enableAjaxValidation' => true])->textInput() ?>
      <hr>
      <div class="row">
      <?php
        $previous = $current - 1;
        ...
        echo Html::tag('div', Html::tag('a', Yii::t('app', 'Finish'), [
            'href' => "#step-{$next}",
            'class' => 'btn btn-xl btn-block btn-primary btn-submit'
        ]), [
            'class' => 'col-md-3 col-md-offset-6 col-xs-6'
        ]);
        $current++;
  ...
  <div class="section" data-anchor="step-<?= $current ?>">
    ...
    <div id="wait-panel" class="container panel">
