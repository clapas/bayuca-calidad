...
$this->title = Yii::t('app', 'Met expectations evolution');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="met-expectation-evolution">
...
<?php
$betterLbl = Yii::t('app', 'Better than expected');
$equalLbl = Yii::t('app', 'As expected');
$worseLbl = Yii::t('app', 'Worse than expected');
              ...
              yAxes: [{
                  ticks: {
                      ...
                      callback: function (value, index, values) {
                          switch (index) {
                              case 0: return '$betterLbl';
                              case 1: return '$equalLbl';
                              case 2: return '$worseLbl';
                          }
                      }
                  },
              }]
