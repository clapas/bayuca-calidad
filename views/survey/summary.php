    ...
    <div class="col-md-8 col-md-offset-2">
      <div class="panel panel-default">
        <table class="table lead">
          <tbody>
            <tr>
              <td><span class="glyphicon glyphicon-calendar"></span> <?= $periods[0]['label'] ?></td>
            ...
            <tr>
              <td><span class="glyphicon glyphicon-calendar"></span> <?= $periods[1]['label'] ?></td>
